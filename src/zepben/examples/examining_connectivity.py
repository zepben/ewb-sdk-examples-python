...
def fancy_print_connectivity(equipment: ConductingEquipment, phases=None):
    if phases:
...
fancy_print_connectivity(tx)
fancy_print_connectivity(tx, phases=PhaseCode.N)
fancy_print_connectivity(breaker, phases=PhaseCode.BC)
