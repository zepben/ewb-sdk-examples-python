...
from zepben.evolve import AcLineSegment, Disconnector, PowerTransformer, TransformerFunctionKind, NetworkService, Terminal, PowerTransformerEnd, EnergyConsumer, \
    PerLengthSequenceImpedance, PhaseCode, EnergyConsumerPhase, SinglePhaseKind
...
ec_634_pha = EnergyConsumerPhase(phase=SinglePhaseKind.A, p_fixed=160, q_fixed=110)
ec_634_phb = EnergyConsumerPhase(phase=SinglePhaseKind.B, p_fixed=120, q_fixed=90)
ec_634_phc = EnergyConsumerPhase(phase=SinglePhaseKind.C, p_fixed=120, q_fixed=90)
...
ec_645_phb = EnergyConsumerPhase(phase=SinglePhaseKind.B, p_fixed=170, q_fixed=125)
...
ec_646_phb = EnergyConsumerPhase(phase=SinglePhaseKind.B, p=230, q=132)
...
ec_652_pha = EnergyConsumerPhase(phase=SinglePhaseKind.A, p=128, q=86)
...
ec_671_pha = EnergyConsumerPhase(phase=SinglePhaseKind.A, p_fixed=385, q_fixed=220)
ec_671_phb = EnergyConsumerPhase(phase=SinglePhaseKind.B, p_fixed=385, q_fixed=220)
ec_671_phc = EnergyConsumerPhase(phase=SinglePhaseKind.C, p_fixed=385, q_fixed=220)
...
ec_675_pha = EnergyConsumerPhase(phase=SinglePhaseKind.A, p_fixed=485, q_fixed=190)
ec_675_phb = EnergyConsumerPhase(phase=SinglePhaseKind.B, p_fixed=68, q_fixed=60)
ec_675_phc = EnergyConsumerPhase(phase=SinglePhaseKind.C, p_fixed=290, q_fixed=212)
...
ec_692_phc = EnergyConsumerPhase(phase=SinglePhaseKind.C, p=170, q=151)
...
ec_611_phc = EnergyConsumerPhase(phase=SinglePhaseKind.C, p=170, q=80)
...
for io in [vr_650_632, vr_650_632_t1, vr_650_632_t2, vr_650_632_e1, vr_650_632_e2, l_632_645, l_632_645_t1, l_632_645_t2, l_632_633, l_632_633_t1, l_632_633_t2,
           ...
           ec_675_phc, ec_675, ec_692_t, ec_692_pha, ec_692_phb, ec_692_phc, ec_692, ec_611_t, ec_611_pha, ec_611_phb, ec_611_phc, ec_611, plsi_601, plsi_602,
           plsi_603, plsi_604, plsi_605, plsi_606, plsi_607]:
    network.add(io)
